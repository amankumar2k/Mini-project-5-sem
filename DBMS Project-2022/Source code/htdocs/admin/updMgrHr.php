    ...
    <?php
        ...
        if($_SERVER['REQUEST_METHOD'] == 'POST' and isset($_POST['action'])){
            ...
            if($action == "update"){
                ...
                $salary = $_POST['Salary'];
                $deptid = $_POST['DeptID'];
                $sql = "UPDATE `employee` SET `EmpID`='$empid',`EmpName`='$empname',`DOB`='$dob',`Address`='$address',`Gender`='$gender',`Phone`='$phone',`Salary`='$salary',`SupID`=NULL,`DeptID`='$deptid' WHERE `EmpID`='$EmpID'";
                $result = mysqli_query($con, $sql);
